...
use F4\Pechkin\DataType\InputRichBlockMap;
...
final class InputRichBlockMapTest extends TestCase
{
    ...
    {
        $data = $this->loadFixture('input_rich_block_map_full.json');
        $obj = InputRichBlockMap::fromArray($data);

        $this->assertInstanceOf(InputRichBlockMap::class, $obj);
    ...
    {
        $data = $this->loadFixture('input_rich_block_map_minimal.json');
        $obj = InputRichBlockMap::fromArray($data);
