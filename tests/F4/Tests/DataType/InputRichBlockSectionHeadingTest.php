...
use F4\Pechkin\DataType\InputRichBlockSectionHeading;
...
final class InputRichBlockSectionHeadingTest extends TestCase
{
    ...
    {
        $data = $this->loadFixture('input_rich_block_section_heading_full.json');
        $obj = InputRichBlockSectionHeading::fromArray($data);

        $this->assertInstanceOf(InputRichBlockSectionHeading::class, $obj);
