...
final class MessageTest extends TestCase
{
    ...
    public function testFromArrayCreatesCorrectStructure(): void
    {
        ...
        $this->assertInstanceOf(User::class, $message->receiver_user);
        $this->assertSame(99, $message->ephemeral_message_id);
        $this->assertInstanceOf(CommunityChatAdded::class, $message->community_chat_added);
        $this->assertInstanceOf(CommunityChatRemoved::class, $message->community_chat_removed);
